...
function build_dynamic_widgets_layout()
  ...
  -- nil guards: some widgets are unavailable on somewm (X11-only tooling)
  if autolock_widget then layout:add(autolock_widget) end
  if mpris_separator then layout:add(mpris_separator) end
  if mpris then layout:add(mpris) end
  return layout
end
